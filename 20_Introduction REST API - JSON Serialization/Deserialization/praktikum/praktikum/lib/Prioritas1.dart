...
class _ContactPageState extends State<ContactPage> {
  ...
  Future<void> addContactToServer(Contact contact) async {
    try {
  ...
  Future<void> fetchContactsFromServer() async {
    try {
      ...
      if (response.statusCode == 200) {
        final List<dynamic> jsonContacts = response.data;
        final List<Contact> serverContacts =
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        if (_selectedIndex == -1) {
                          ...
                          addContact();
                          addContactToServer(contacts.last);
                        } else {
                          // Mode edit kontak
                          editContact();
                        }
